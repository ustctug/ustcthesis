...
- [ ] 已经阅读《研究生学位论文撰写模板》或《中国科学技术大学本科毕业论文（设计）格式式样》
- [ ] 已经将模板升级到了最新版
...
- 编译的系统：macOS / Ubuntu / Windows / Overleaf
- TeX 发行版：TeX Live 2026 / MacTeX 2026 / MiKTeX 2.9.6753
- 模板类型：doctor / master / bachelor

## 描述问题

学位论文撰写模板第 xx 页要求……而模板编译的结果是……
